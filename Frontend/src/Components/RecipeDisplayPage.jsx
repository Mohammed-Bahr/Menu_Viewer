...
// import { Clock, Users, ChefHat, ArrowLeft, Eye, Code, Heart, Share2, Printer } from 'lucide-react';
...
//         // FIX 2: Only set fallback data for general errors, not for "Not Found" errors.
//         if (err.message !== 'Recipe not found') {
//           setRecipe({
//             _id: id,
//             title: "Sample Recipe (Connection Error)",
//             description: "This is a demo recipe shown because the server could not be reached.",
...
//           });
//         } else {
//             // If it's a 404, ensure the recipe is null so the "Not Found" page displays.
//             setRecipe(null);
//         }
//       } finally {
//         setLoading(false);
...
//     if (!recipe) return; // Prevent sharing if recipe isn't loaded
//     if (navigator.share) {
//       try {
...
//   // This condition now works as intended for 404 errors.
//   if (error && !recipe) {
//     return (
//       <div className="min-h-screen bg-gray-50 flex items-center justify-center">
...
//           <p className="text-gray-600 mb-6">Sorry, we couldn't find the recipe you're looking for. It might have been moved or deleted.</p>
//           <button
//             onClick={handleBack}
...
//   if (!recipe) {
//     // This is a final fallback, though unlikely to be hit with the new logic.
//     return (
//       <div className="min-h-screen bg-gray-50 flex items-center justify-center">
//         <div className="text-xl font-semibold text-gray-600">Could not load recipe data.</div>
//       </div>
//     );
//   }
...
//                 className={`p-2 rounded-full transition-colors favorite-button ${
...
//               >
//                  {/* IMPROVEMENT: Using a proper icon from the library */}
...
//         {showDebugView ? (
//           /* Debug View remains largely the same, but with improved robustness */
...
//                 <img
//                   src={recipe.imageUrl || 'https://via.placeholder.com/800x400/f3f4f6/9ca3af?text=No+Image'}
//                   alt={recipe.title}
//                   loading="lazy"
//                   className="w-full h-full object-cover"
//                   onError={(e) => {
//                     e.target.onerror = null; // prevent infinite loops
//                     e.target.src = 'https://via.placeholder.com/800x400/f3f4f6/9ca3af?text=Image+Error';
//                   }}
//                 />
...
//                   {/* FIX 3: Handle empty arrays correctly to show the fallback message */}
...
//                            {/* Ensure instruction is an object before accessing properties */}
...
//         )}
//       </div>
//       {/* FIX 4: Removed stray, malformed closing <div> tag */}
//     </div>
//   );
// };
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 recipe-stats">
              {recipe.cookingTime && (
                <div className="bg-white rounded-lg p-6 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-gray-800">{recipe.cookingTime} mins</p>
                  </div>
                </div>
              )}
              ...
              <div className="bg-white rounded-lg p-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-gray-800">{recipe.difficulty || 'Medium'}</p>
                </div>
              </div>
            </div>
